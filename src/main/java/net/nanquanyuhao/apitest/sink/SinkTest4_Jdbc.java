package net.nanquanyuhao.apitest.sink;/**
...
import net.nanquanyuhao.apitest.source.SourceTest4_UDF;
...
//        });
    ...
    public static class MyJdbcSink extends RichSinkFunction<SensorReading> {
        ...
        public void open(Configuration parameters) throws Exception {
            connection = DriverManager.getConnection("jdbc:mysql://192.168.235.101:3306/test", "root", "123456");
