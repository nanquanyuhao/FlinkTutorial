package net.nanquanyuhao.apitest.source;/**
...
public class SourceTest3_Kafka {
    ...
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("key.deserializer", "org.apache.kafka.sh.common.serialization.StringDeserializer");
        properties.setProperty("value.deserializer", "org.apache.kafka.sh.common.serialization.StringDeserializer");
